<template>
  <div>
    <DashboardHeader title="المستأجرين" />
    <PageLinks
      :RouteCount="2"
      :link1="{ route: '/', title: 'لوحه التحكم' }"
      :link2="{ route: '/tenants', title: 'المستأجرين' }"
    />
    ...
    <div class="alwan-table">
      <!-- header 1 -->
      <div class="head-1">
        <p class="m-0">المستأجرين</p>
        <div>
          <button>
            <IconExport color="#c4c4c4" />
          </button>
          <button type="button" data-bs-toggle="modal" data-bs-target="#tanantModal">
