<template>
  <div>
    <!-- alwan table -->
    <div class="alwan-table full-table m-0">
      <!-- header 1 -->
      <div class="head-1">
        <p class="m-0">تقرير العقارات والوحدات</p>
        <div>
          <button>
            <IconExport color="#c4c4c4" />
          </button>
          <button type="button" data-bs-toggle="modal" data-bs-target="#unitsReportModal">
            ...
            <td>
              <div class="dropdown more">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownlist">
                  <li><a class="dropdown-item" href="#">تنزيل</a></li>
