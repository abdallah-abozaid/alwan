<template>
  <div>
    <div class="btns">
      ...
      <button :class="active == 2 ? 'active' : ''" @click="active = 2">استحقاقات المالك</button>
    </div>
    <!-- alwan table السجلات-->
      ...
      <div class="table">
        <table>
          ...
          <tr>
            ...
            <td>1</td>
            <td>أجور الإدارة</td>
            <td class="note">10-10-2022</td>
            <td class="note">10-10-2022</td>
            <td class="note">6000</td>
            <td>200</td>
            <td><IconDone color="#0f6" /></td>
    ...
    <!-- ******************************************************* -->
    <div class="alwan-table full-table" v-if="active == 2">
      <!-- header 1 -->
      <div class="head-1">
        <p class="m-0">استحقاقات المالك</p>
        <div>
          <button>
            <IconExport color="#c4c4c4" />
          </button>
